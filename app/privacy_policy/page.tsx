          ...
          <div className="space-y-8 text-gray-300">
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                safeguard your information when you use our services. Please
                read this privacy policy carefully. If you do not agree with the
                terms of this privacy policy, please do not access the site or
                use our services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed mb-4">
                ...
                us when you apply for a loan, express an interest in obtaining
            ...
            <section>
              ...
              <ul className="list-disc ml-6 space-y-2">
                <li>
                  To process your loan application and verify your identity
                </li>
            ...
            <section>
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>
                  <strong className="text-white">For Legal Compliance:</strong>{" "}
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                permitted by law. This typically includes the duration of your
                loan plus seven years for compliance with financial regulations.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc ml-6 space-y-2">
                ...
                <li>
                  ...
                  can object to our processing of your information.
                </li>
              </ul>
              <p className="leading-relaxed mt-4">
